...
public class ChangePasswordActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(!utils.isNetworkAvailable(getApplication())){
            Toast.makeText(ChangePasswordActivity.this, "Network unavailable.", Toast.LENGTH_SHORT).show();
        }
    }
        ...
        bt_submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(newPass.isEmpty() || oldPass.isEmpty() || confirmPass.isEmpty()){
                    Toast.makeText(ChangePasswordActivity.this, "Please complete all fields.", Toast.LENGTH_SHORT).show();
                                        ...
                                        user.updatePassword(newPass).addOnCompleteListener(new OnCompleteListener<Void>() {
                                            ...
                                            public void onComplete(@NonNull Task<Void> task) {
                                                if (task.isSuccessful()) {
                                                    ...
                                                    Toast.makeText(ChangePasswordActivity.this, "Password has NOT been changed.", Toast.LENGTH_SHORT).show();
                                                }
                                            }
                                        });
                                    } else {
                                        Toast.makeText(ChangePasswordActivity.this, "Failed to change password. Check your old password.", Toast.LENGTH_LONG).show();
                                    }
                                }
                            });
                }else{
