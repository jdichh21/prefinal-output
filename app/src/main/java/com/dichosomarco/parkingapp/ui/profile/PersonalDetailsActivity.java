...
public class PersonalDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(!utils.isNetworkAvailable(getApplication())){
            Toast.makeText(PersonalDetailsActivity.this, "Network unavailable.", Toast.LENGTH_SHORT).show();
        }
    }
        ...
        bt_submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(userObj.name.isEmpty() || userObj.contact_no.isEmpty()){
                    Toast.makeText(PersonalDetailsActivity.this, "Please complete all fields.", Toast.LENGTH_SHORT).show();
                }else if(!utils.isNameValid(userObj.name)){
                    Toast.makeText(PersonalDetailsActivity.this,"Invalid name.",Toast.LENGTH_SHORT).show();
                }else if(!utils.isPhoneNoValid(userObj.contact_no)){
                    Toast.makeText(PersonalDetailsActivity.this,"Invalid phone number.",Toast.LENGTH_SHORT).show();
                }else{
        ...
        bt_submit_email.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(newEmail.isEmpty() || currentPasswordText.getText().toString().isEmpty() || email.isEmpty()) {
                    ...
                    Toast.makeText(PersonalDetailsActivity.this, "Please enter a new e-mail address.", Toast.LENGTH_SHORT).show();
                }else{
                    ...
                    user.reauthenticate(credential)
                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                @Override
                                public void onComplete(@NonNull Task<Void> task) {
                                    Log.d(String.valueOf(PersonalDetailsActivity.this.getClass()), "User has re-authenticated.");
                                    user.updateEmail(newEmail)
                                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                @Override
                                                public void onComplete(@NonNull Task<Void> task) {
                                                    if (task.isSuccessful()) {
                                                        Toast.makeText(PersonalDetailsActivity.this, "E-mail address has been updated.", Toast.LENGTH_SHORT).show();
                                                        ...
                                                        Toast.makeText(PersonalDetailsActivity.this, "Failed to update e-mail address.", Toast.LENGTH_SHORT).show();
                                                    }
                                                }
                                            });
                                }
