...
public class ForgotPasswordActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(!utils.isNetworkAvailable(getApplication())){
            Toast.makeText(ForgotPasswordActivity.this, "Network unavailable.", Toast.LENGTH_SHORT).show();
        }
    }
        ...
        sendMailBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(TextUtils.isEmpty(txt_email)){
                    Toast.makeText(ForgotPasswordActivity.this,"E-mail address cannot be blank.",Toast.LENGTH_SHORT).show();
                }else{
                    ...
                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            if (task.isSuccessful()) {
                                Toast.makeText(ForgotPasswordActivity.this, "An e-mail has been sent to ".concat(email)+".", Toast.LENGTH_SHORT).show();
                                finish();
                            }else{
