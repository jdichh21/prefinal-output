        ...
        loginBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(TextUtils.isEmpty(txt_email)){
                    Toast.makeText(LoginActivity.this,"E-mail address cannot be blank.",Toast.LENGTH_SHORT).show();
...
//                        db.getReference("Users").child(auth.getCurrentUser().getUid()).child("isVerified").setValue(0);
                        ...
                        auth.getCurrentUser().sendEmailVerification()
                                .addOnCompleteListener(LoginActivity.this, new OnCompleteListener() {
                                    ...
                                    public void onComplete(@NonNull Task task) {
                                        if (task.isSuccessful()) {
                                            Toast.makeText(LoginActivity.this, "An e-mail has been sent to " + auth.getCurrentUser().getEmail()+".", Toast.LENGTH_SHORT).show();
                    ...
                    try {
                        ...
                        Toast.makeText(LoginActivity.this, "Invalid log-in info.", Toast.LENGTH_SHORT).show();
