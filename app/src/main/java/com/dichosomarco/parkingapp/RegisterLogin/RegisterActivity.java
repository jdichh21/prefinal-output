package com.dichosomarco.parkingapp.RegisterLogin;
        ...
        registerBtn.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                ...
                if(!utils.isNameValid(txt_name)){
                    ...
                    Toast.makeText(RegisterActivity.this,"E-mail address cannot be blank.",Toast.LENGTH_SHORT).show();
                        ...
                        if(task.isSuccessful()){
                            ...
                            db.getReference("Users")
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    if(task.isSuccessful()){
                                        Toast.makeText(RegisterActivity.this,"Successfully registered. Check your e-mail for verification.",Toast.LENGTH_LONG).show();
                                        ...
                                        user.sendEmailVerification()
                                                .addOnCompleteListener(RegisterActivity.this, new OnCompleteListener() {
                                                    ...
                                                    public void onComplete(@NonNull Task task) {
                                                        if (task.isSuccessful()) {
                                                            Toast.makeText(RegisterActivity.this, "An e-mail for verification has been sent to " + user.getEmail()+".", Toast.LENGTH_SHORT).show();
                                                            FirebaseAuth.getInstance().signOut();
                                                        } else {
                                                            Toast.makeText(RegisterActivity.this, "Failed to send e-mail for verification.", Toast.LENGTH_SHORT).show();
                                                            FirebaseAuth.getInstance().signOut();
                                                        }
                                                    }
                                                });
                            ...
                            try{
                                ...
                                Toast.makeText(RegisterActivity.this, "This e-mail address is already in use.", Toast.LENGTH_SHORT).show();
