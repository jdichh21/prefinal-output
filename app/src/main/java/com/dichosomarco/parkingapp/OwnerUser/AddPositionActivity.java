package com.dichosomarco.parkingapp.OwnerUser;
...
import com.dichosomarco.parkingapp.classes.SlotNoInfo;
...
public class AddPositionActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    AppCompatEditText areaNameText,bankIdText,bankNameText,amount2Text,amount3Text,amount4Text,totalSlotsText;
    Button loadFromFile;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(!utils.isNetworkAvailable(getApplication())){
            Toast.makeText(AddPositionActivity.this, "Network unavailable.", Toast.LENGTH_SHORT).show();
        }
    ...
    private void attachListeners() {
        addLocationBtn.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                ...
                if(globalLatLng==null){
                ...
                }else if(areaName.equals("") || bankId.equals("") || bankName.equals("") || amount2.equals("") || amount3.equals("") || amount4.equals("") || totalSlots.equals("")){
                    Toast.makeText(AddPositionActivity.this, "Please complete all fields.", Toast.LENGTH_SHORT).show();
                }else if(!utils.isbankIdValid(bankId)){
                    Toast.makeText(AddPositionActivity.this, "Invalid banking information.", Toast.LENGTH_SHORT).show();
                }else if(slotNos.size()>Integer.parseInt(totalSlots)){
                    Toast.makeText(AddPositionActivity.this, "Slot names are more than the number of slots.", Toast.LENGTH_SHORT).show();
                }else if(slotNos.size()<Integer.parseInt(totalSlots)){
                    Toast.makeText(AddPositionActivity.this, "Number of slots are more than the slot names.", Toast.LENGTH_SHORT).show();
                }else{
                    ...
                    final BankInfo bankInfo=new BankInfo(bankId,bankName);
                                ...
                                db.getReference("bankInfo")
                                    ...
                                    public void onComplete(@NonNull Task<Void> task) {
                                        if (task.isSuccessful()) {
                                            ...
                                            Toast.makeText(AddPositionActivity.this, "Failed to add bank details.", Toast.LENGTH_SHORT).show();
                                        }
                                    }
                                });
                            } else {
                ...
                if(location!=null){
                    supportMapFragment.getMapAsync(new OnMapReadyCallback() {
                        ...
                        public void onMapReady(GoogleMap googleMap) {
                            ...
                            googleMap.animateCamera(CameraUpdateFactory.newLatLngZoom(gpsLatLng,15));
                        }
                    });
                }
            }
