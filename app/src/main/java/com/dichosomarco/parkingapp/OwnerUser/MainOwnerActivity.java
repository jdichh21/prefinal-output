...
public class MainOwnerActivity extends AppCompatActivity {
    ...
    public void onResume(){
        super.onResume();
        // put your code here...
        Log.d(String.valueOf(MainOwnerActivity.this.getClass()),"Resume e-mail verification.");
    }
                ...
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        for (DataSnapshot dataSnapshot : snapshot.getChildren()) {
                            ...
                            Log.d(String.valueOf(MainOwnerActivity.this.getClass()),"Loading parking spot: "+String.valueOf(parkingArea));
