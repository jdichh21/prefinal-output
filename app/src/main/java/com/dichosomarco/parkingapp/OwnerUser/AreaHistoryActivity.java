...
import com.dichosomarco.parkingapp.classes.BookedSlotKey;
...
import com.dichosomarco.parkingapp.utils.adapters.BookingHistoryAdapter;
...
public class AreaHistoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(!utils.isNetworkAvailable(getApplication())){
            Toast.makeText(AreaHistoryActivity.this, "Network unavailable.", Toast.LENGTH_SHORT).show();
        }
    }
