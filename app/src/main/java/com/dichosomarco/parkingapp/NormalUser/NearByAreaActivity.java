...
import com.dichosomarco.parkingapp.classes.ClosestDistance;
...
import com.dichosomarco.parkingapp.utils.adapters.CloseLocationAdapter;
...
public class NearByAreaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(!utils.isNetworkAvailable(getApplication())){
            Toast.makeText(NearByAreaActivity.this, "Network unavailable.", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void initComponents() {
        ...
        getSupportActionBar().setTitle("Available Parking Spots");
