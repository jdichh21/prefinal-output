...
public class GPSMapActivity extends AppCompatActivity implements OnMapReadyCallback{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if(!utils.isNetworkAvailable(getApplication())){
            Toast.makeText(GPSMapActivity.this, "Network unavailable.", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void initComponents() {
        ...
        getSupportActionBar().setTitle("Map Overview");
        ...
        supportMapFragment.getMapAsync(new OnMapReadyCallback() {
            ...
            public void onMapReady(GoogleMap googleMap) {
                ...
                if(globalLatLngIntent != null){
                    ...
                    gMap.animateCamera(CameraUpdateFactory.newLatLngZoom(globalLatLngIntent,15));
                }else{
